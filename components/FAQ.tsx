...
const faqs = [
  ...
  {
    q: "ما الفرق بين أنواع الشاليهات؟",
    a: "شاليهات الميني مخصصة للزيارة القصيرة والحجز المباشر من بوابة 2، والشاليهات الصغيرة مناسبة للجلسات العائلية الهادئة، والوسط توفر مساحة أوسع، أما القبة المالديفية والقبة VIP فهي خيارات أكثر تميزًا وخصوصية.",
  },
  {
  ...
  },
  {
    ...
    a: `نعم، واتساب هو قناتنا الرئيسية للحجز والتواصل. راسلنا على الرقم ${DISPLAY_PHONE} بالتاريخ ونوع الشاليه وسنساعدك في إتمام حجزك فوراً.`,
  },
  {
