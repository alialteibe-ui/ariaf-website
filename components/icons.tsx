/**
 * Inline SVG icon library — thin line style, 1.5px stroke, currentColor.
 * All icons use a 24×24 viewBox to match standard sizing conventions.
 * Pass className to control size and color: className="w-5 h-5 text-gold-400"
 */
...
export function DropletIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2C12 2 5 10.4 5 14.5a7 7 0 0 0 14 0C19 10.4 12 2 12 2z" />
    </svg>
  );
}
...
export function PawPrintIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 22c-3.5 0-8-2.5-8-7 0-2.5 2.5-4 4-4h8c1.5 0 4 1.5 4 4 0 4.5-4.5 7-8 7z" />
    </svg>
  );
}
